...
/// <summary>One selectable entry in a <see cref="DataTray.Sdk.Tools.ToolFieldType.ConnectionPicker"/> or
/// <see cref="DataTray.Sdk.Tools.ToolFieldType.DatabasePicker"/> dropdown: the value stored on the field
