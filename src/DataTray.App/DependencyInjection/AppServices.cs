...
using DataTray.Core.Formatting;
...
using DataTray.Infrastructure.Store;
using DataTray.Infrastructure.Update;
using DataTray.Mcp.Hosting;
using DataTray.Sdk;
using DataTray.Sdk.Mcp;
using Microsoft.Extensions.DependencyInjection;

namespace DataTray.App.DependencyInjection;
...
public static class AppServices
{
    public static IServiceProvider Build()
    {
        ...
        // Auto-register any class that opted into a lifetime marker (DataTray.Sdk.Extensibility). Additive
        ...
        services.AddMarkedServices(
            typeof(ConnectionService).Assembly,     // DataTray.Core
            typeof(JsonPluginStateStore).Assembly,  // DataTray.Infrastructure
            typeof(AppServices).Assembly);          // DataTray.App
