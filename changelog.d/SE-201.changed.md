- **The date editor's calendar now follows the app's own theme.** The day grid, the month header and the
  navigation arrows used to come straight from the Fluent theme, so the panel around them matched
  DataTray while the calendar inside it did not. Day cells, hover and the month header now use the app's
